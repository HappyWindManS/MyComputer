...
namespace CalculationModuleUWP
{
    internal class CalculationLogic
    {
        ...
        /// <param name="grade"></param>
        /// <returns></returns>
        internal static string ProperFraction(string grade)
        {
            int indexes = grade.IndexOf("/");
            int element = Math.Abs(int.Parse(grade.Substring(0, indexes)));
            int denominator = int.Parse(grade.Substring(indexes + 1, grade.Length - indexes - 1));
        ...
        /// <param name="grade"></param>
        /// <returns></returns>
        internal static string branch(string grade)
        {
            if(grade.Contains("/"))
            {
        ...
        /// <param name="two"></param>
        /// <returns></returns>
        internal static string consequence(string symbol,double one,double two)
        {
            switch(symbol)
            {
                case "＋":
        ...
        /// <returns></returns>
        internal static string ScoreReversePolishType(string strEquation)
        {
            Stack<object> stacknum = new Stack<object>();
            Stack<string> stacksymbol = new Stack<string>();
            stacksymbol.Push("#");
        ...
        /// <param name=""></param>
        /// <returns></returns>
        internal static int Evaluation(string topic)
        {
        ...
        /// <returns></returns>
        internal static int GetOperationLevel(string c)
        {
            switch (c)
            {
                case "＋": return 1;
        ...
        /// 生成题目
        /// </summary>
        //internal static void GenerateTitle()
        ...
        //}
        //无分数结果验算
        //internal static string consequence(string equation)
        //{
        //    //小数与整数运算           
        ...
        //    }
        //    //六年级题目的解法
        //    internal static string solution(string topic)
        //    {
