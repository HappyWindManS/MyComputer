...
namespace MusicStoreEntity.UserAndRole
{
    ...
    public class IdentityManager
    {
        ...
        {
            var rm = new RoleManager<ApplicationRole>(new RoleStore<ApplicationRole>(new TestEntityContext()));
        ...
        {
            var um = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new TestEntityContext()))
            {
        ...
        public bool CreateUser(ApplicationUser user, string password, TestEntityContext dbContext)
        {
